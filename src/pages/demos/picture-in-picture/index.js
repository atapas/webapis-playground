  ...
  return (
    <div className="flex-colums">
      <div className="flex-colums tw-text-center">
        <center>
          <video
            className="tw-w-screen sm:tw-w-1/2 tw-self-center m-0 sm:tw-m-4"
      ...
      <div className="flex-colums" style={{ padding: '1rem' }}>
        <h1 className="tw-text-center tw-text-2em tw-font-bold">
          Let us know about our planets
        </h1>
        <h2 className="tw-text-center tw-text-1.5em tw-font-bold tw-py-10px">
          Earth
        </h2>
        <p>
