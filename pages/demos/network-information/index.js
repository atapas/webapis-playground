    ...
    <div className="flex-colums">
      <ul id="network-info-main">
          <li>
              ...
              <span><b>{ networkInfo.effectiveType }</b></span>
          </li>
          <li>
              <span>Round Trip Time(rtt):{' '}</span>
              <span><b>{ networkInfo.rtt }</b></span>
          </li>
          <li>
              <span>Bandwidth estimate(in MBPS):{' '}</span>
              <span><b>{ networkInfo.downlink }</b></span>
          </li>
          <li>
              <span>Max Bandwidth estimate(in MBPS):{' '}</span>
              <span><b>{ networkInfo.downlinksMax }</b></span>
          </li>
          <li>
              <span>Save data enabled:{' '}</span>
              <span><b>{ networkInfo.saveData ? 'Yes' : 'No' }</b></span>
          </li>
          <li>
              <span>Device Connection Type:{' '}</span>
              <span><b>{ networkInfo.type }</b></span>
          </li>
      </ul>
    </div>
  );
